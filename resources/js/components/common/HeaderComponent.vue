        ...
        <div class="header__builder">
            <div class="row">
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                    ...
                    <div class="logo">
                        <a :href="'/'">
                            <img width="228" height="38" :src="'/images/logo.png'" alt="Logo">
                        </a>
                    </div>
...
<!--                                                <li class="menu-item">
                                                ...
                                                <li class="menu-item menu-item-has-children has-children">
                                                    <a class="splitting-text-anim-2" data-splitting="chars" href="javascript:;">Pages</a>
                                                    <ul class="sub-menu">
                                                        <li class="menu-item">
                                                            <a class="splitting-text-anim-1" data-splitting="chars" :href="'/works'">Works</a>
                                                        </li>
                                                        <li class="menu-item">
                                                            <a class=" splitting-text-anim-1" data-splitting="chars" :href="'/blogs'">Blogs</a>
                                                        </li>
<!--                                                        <li class="menu-item">
...
<script setup>
    ...
    const { currentroute } = defineProps(['currentroute']);
