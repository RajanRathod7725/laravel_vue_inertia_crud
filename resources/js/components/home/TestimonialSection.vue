                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonials-item">
                                <div class="image">
                                    <img decoding="async" src="/images/star.jpg" alt="Barbara Wilson" >
                                    <div class="icon">
                                ...
                                <div class="text lui-text">
                                    <div>
                                        <p>If you need a full-stack expert who understands both development and business needs, look no further. Rajan delivered a top-notch solution that exceeded our expectations!</p>
                                    </div>
                                </div>
                                <div class="info">
                                    <h6 class="name">
                                        <span>Fahad Alghamdi</span>
                                    </h6>
                                    <div class="author">
                                        <span>CEO - Wosul</span>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonials-item">
                                <div class="image">
                                    <img decoding="async" src="/images/star.jpg" alt="Charlie Smith" >
                                    <div class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="44px" height="34px">
                                            <path fill-rule="evenodd" stroke-width="2px" stroke="rgb(0, 0, 0)" fill="rgb(41, 165, 135)" d="M17.360,8.325 C15.490,5.563 11.616,4.762 8.705,6.536 C6.901,7.635 5.815,9.533 5.826,11.567 C5.828,14.854 8.637,17.516 12.101,17.515 C13.290,17.513 14.456,17.192 15.460,16.587 C14.967,17.975 14.049,19.457 12.537,20.942 C11.934,21.533 11.951,22.476 12.574,23.048 C13.198,23.619 14.192,23.604 14.794,23.012 C20.384,17.515 19.658,11.539 17.360,8.333 L17.360,8.325 ZM32.407,8.325 C30.538,5.563 26.663,4.762 23.752,6.536 C21.949,7.635 20.863,9.533 20.873,11.567 C20.875,14.854 23.685,17.516 27.148,17.515 C28.338,17.513 29.503,17.192 30.508,16.587 C30.015,17.975 29.097,19.457 27.585,20.942 C26.982,21.533 26.999,22.476 27.622,23.048 C28.245,23.619 29.239,23.604 29.842,23.012 C35.432,17.515 34.706,11.539 32.407,8.333 L32.407,8.325 Z" />
                                        </svg>
                                ...
                                <div class="text lui-text">
                                    <div>
                                        <p>I was impressed by the professionalism and technical skills. From API integrations to optimizing database queries, everything was delivered on time with exceptional quality. Highly recommended!</p>
                                    </div>
                                </div>
                                <div class="info">
                                    <h6 class="name">
                                        <span>Arpit Thakar</span>
                                    </h6>
                                    <div class="author">
                                        <span>CEO - Vakalat</span>
                                    </div>
                                </div>
                                <div class="bg-img" style="background-image: url(/images/pat-2.png);"></div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonials-item">
                                <div class="image">
                                    <img decoding="async" src="/images/star.jpg" alt="Jennifer Smith" >
                                    <div class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="44px" height="34px">
                                            <path fill-rule="evenodd" stroke-width="2px" stroke="rgb(0, 0, 0)" fill="rgb(41, 165, 135)" d="M17.360,8.325 C15.490,5.563 11.616,4.762 8.705,6.536 C6.901,7.635 5.815,9.533 5.826,11.567 C5.828,14.854 8.637,17.516 12.101,17.515 C13.290,17.513 14.456,17.192 15.460,16.587 C14.967,17.975 14.049,19.457 12.537,20.942 C11.934,21.533 11.951,22.476 12.574,23.048 C13.198,23.619 14.192,23.604 14.794,23.012 C20.384,17.515 19.658,11.539 17.360,8.333 L17.360,8.325 ZM32.407,8.325 C30.538,5.563 26.663,4.762 23.752,6.536 C21.949,7.635 20.863,9.533 20.873,11.567 C20.875,14.854 23.685,17.516 27.148,17.515 C28.338,17.513 29.503,17.192 30.508,16.587 C30.015,17.975 29.097,19.457 27.585,20.942 C26.982,21.533 26.999,22.476 27.622,23.048 C28.245,23.619 29.239,23.604 29.842,23.012 C35.432,17.515 34.706,11.539 32.407,8.333 L32.407,8.325 Z" />
                                        </svg>
                                ...
                                <div class="text lui-text">
                                    <div>
                                        <p>Working with Rajan was a game-changer! Their expertise in Laravel and Vue.js helped us scale our platform seamlessly, improving performance and user experience beyond expectations.</p>
                                    </div>
                                </div>
                                <div class="info">
                                    <h6 class="name">
                                        <span>Jigar Shah</span>
                                    </h6>
                                    <div class="author">
                                        <span>CEO &amp; Founder - Eliteware</span>
                                    </div>
                                </div>
                                <div class="bg-img" style="background-image: url(/images/pat-2.png);"></div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonials-item">
                                <div class="image">
                                    <img decoding="async" src="/images/star.jpg" alt="Roy Wang" >
                                    <div class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="44px" height="34px">
                                            <path fill-rule="evenodd" stroke-width="2px" stroke="rgb(0, 0, 0)" fill="rgb(41, 165, 135)" d="M17.360,8.325 C15.490,5.563 11.616,4.762 8.705,6.536 C6.901,7.635 5.815,9.533 5.826,11.567 C5.828,14.854 8.637,17.516 12.101,17.515 C13.290,17.513 14.456,17.192 15.460,16.587 C14.967,17.975 14.049,19.457 12.537,20.942 C11.934,21.533 11.951,22.476 12.574,23.048 C13.198,23.619 14.192,23.604 14.794,23.012 C20.384,17.515 19.658,11.539 17.360,8.333 L17.360,8.325 ZM32.407,8.325 C30.538,5.563 26.663,4.762 23.752,6.536 C21.949,7.635 20.863,9.533 20.873,11.567 C20.875,14.854 23.685,17.516 27.148,17.515 C28.338,17.513 29.503,17.192 30.508,16.587 C30.015,17.975 29.097,19.457 27.585,20.942 C26.982,21.533 26.999,22.476 27.622,23.048 C28.245,23.619 29.239,23.604 29.842,23.012 C35.432,17.515 34.706,11.539 32.407,8.333 L32.407,8.325 Z" />
                                        </svg>
                                ...
                                <div class="text lui-text">
                                    <div>
                                        <p>From payment gateway integration to deployment, Rajan handled every aspect flawlessly. The project was completed efficiently, and communication was always clear and transparent.</p>
                                    </div>
                                </div>
                                <div class="info">
                                    <h6 class="name">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonials-item">
                                <div class="image">
                                    <img decoding="async" src="/images/star.jpg" alt="Paul Freeman" >
                                    <div class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="44px" height="34px">
                                            <path fill-rule="evenodd" stroke-width="2px" stroke="rgb(0, 0, 0)" fill="rgb(41, 165, 135)" d="M17.360,8.325 C15.490,5.563 11.616,4.762 8.705,6.536 C6.901,7.635 5.815,9.533 5.826,11.567 C5.828,14.854 8.637,17.516 12.101,17.515 C13.290,17.513 14.456,17.192 15.460,16.587 C14.967,17.975 14.049,19.457 12.537,20.942 C11.934,21.533 11.951,22.476 12.574,23.048 C13.198,23.619 14.192,23.604 14.794,23.012 C20.384,17.515 19.658,11.539 17.360,8.333 L17.360,8.325 ZM32.407,8.325 C30.538,5.563 26.663,4.762 23.752,6.536 C21.949,7.635 20.863,9.533 20.873,11.567 C20.875,14.854 23.685,17.516 27.148,17.515 C28.338,17.513 29.503,17.192 30.508,16.587 C30.015,17.975 29.097,19.457 27.585,20.942 C26.982,21.533 26.999,22.476 27.622,23.048 C28.245,23.619 29.239,23.604 29.842,23.012 C35.432,17.515 34.706,11.539 32.407,8.333 L32.407,8.325 Z" />
                                        </svg>
                                ...
                                <div class="text lui-text">
                                    <div>
                                        <p>The best developer I’ve worked with! [Your Name] not only built a high-performing application but also provided valuable insights on architecture and scalability. A true problem solver!</p>
                                    </div>
                                </div>
                                <div class="info">
                                    <h6 class="name">
                                        <span>Naresh Chauhan</span>
                                    </h6>
                                    <div class="author">
                                        <span>CEO - Pavans Group</span>
                                    </div>
                                </div>
                                <div class="bg-img" style="background-image: url(/images/pat-2.png);"></div>
                            </div>
